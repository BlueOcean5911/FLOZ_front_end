  ...
  return (
    <div className="h-full flex flex-col">
      <div className="flex items-center p-4 bg-[#DDF1EE] text-[13px]">
        ...
        <button className="w-8 h-8 justify-center border-2 mr-[5px] rounded-md bg-white border-[#349989] flex items-center" onClick={() => calendarRef.current.getApi().prev()}>
        ...
        <button className="w-8 h-8 justify-center flex items-center bg-white border-2 rounded-md border-[#349989]" onClick={() => calendarRef.current.getApi().next()}>
          <svg width="8" height="12" viewBox="0 0 8 12" fill="none" xmlns="http://www.w3.org/2000/svg">
