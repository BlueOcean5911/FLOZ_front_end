...
export default function ProjectView({
  ...
  todolist: { _id: any, time: any, name: any, title: any, desc: any, type: any }[] | null;
}) {
  ...
  function closeTask(value) {
    todoList.splice(todoList.findIndex(item => item.title == value.title), 1);
              ...
              <div >
                <div className="flex pl-4 " style={{ borderLeft: "2px solid gainsboro" }}>
                  ...
                  <div className="pl-2">
                    ...
                    <p className="my-auto py-1 text-sm">Aug 29, 2023 8.42am</p>
                    <p className="my-auto py-1 text-sm">Aug 29, 2023 8.42am</p>
                    <p className="my-auto py-1 text-sm">Aug 29, 2023 8.42am</p>
                    <p className="my-auto py-1 text-sm">Aug 29, 2023 8.42am</p>
                  </div>
          ...
          <div className=" manage-project-box border rounded border-stone-300 p-3 my-4 bg-white" >
            ...
            <div className="grid grid-cols-2 ">
              <div className="col-span-1">
                <div className="my-2 border rounded border-stone-300" style={{ background: "#349989" }}>
                  <p className="text-center py-1">Architecture-ABC</p>
                </div>
                <div className="my-2 border rounded border-stone-300" style={{ background: "#FF5BA0" }}>
                  <p className="text-center py-1">Architecture-ABC</p>
                </div>
                <div className="my-2 border rounded border-stone-300" style={{ background: "#349989" }}>
                  <p className="text-center py-1">Architecture-ABC</p>
            ...
            <div className="grid grid-cols-4 gap-5">
              <div>
                <div className="my-1 py-2 flex justify-center border rounded border-stone-300" style={{ background: "#E5E5E5" }}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="20" viewBox="0 0 18 20" fill="none">
                    <g clip-path="url(#clip0_728_11882)">
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M1.84734 -0.0078125C0.971406 -0.0078125 0.261719 0.702187 0.261719 1.57781V18.4031C0.261719 19.2791 0.971406 19.9888 1.84734 19.9888H16.1514C17.0267 19.9888 17.737 19.2791 17.737 18.4031V6.33906L11.8305 -0.0078125H1.84734Z" fill="#747474" />
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M17.7424 6.36059V6.67309H13.7427C13.7427 6.67309 11.7702 6.27934 11.8274 4.57715C11.8274 4.57715 11.8924 6.36059 13.7036 6.36059H17.7424Z" fill="#5C5C5C" />
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M11.8359 0V4.55031C11.8359 5.06781 12.1809 6.36 13.7434 6.36H17.7431L11.8359 0Z" fill="#C9C9C9" />
                  ...
                  <p className="ml-2"> attachment.jpg</p>
                </div>
                <p className="text-center py-1">Name • Oct 10</p>
              </div>
              <div>
                <div className="my-1 py-2 flex justify-center border rounded border-stone-300" style={{ background: "#E5E5E5" }}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="20" viewBox="0 0 18 20" fill="none">
              ...
              <div>
                <div className="mt-1 py-2 flex justify-center border rounded border-stone-300" style={{ background: "#E5E5E5" }}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="20" viewBox="0 0 18 20" fill="none">
                    <g clip-path="url(#clip0_728_11882)">
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M1.84734 -0.0078125C0.971406 -0.0078125 0.261719 0.702187 0.261719 1.57781V18.4031C0.261719 19.2791 0.971406 19.9888 1.84734 19.9888H16.1514C17.0267 19.9888 17.737 19.2791 17.737 18.4031V6.33906L11.8305 -0.0078125H1.84734Z" fill="#747474" />
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M17.7424 6.36059V6.67309H13.7427C13.7427 6.67309 11.7702 6.27934 11.8274 4.57715C11.8274 4.57715 11.8924 6.36059 13.7036 6.36059H17.7424Z" fill="#5C5C5C" />
        ...
        <div className="col-span-1 border rounded border-stone-300 p-3 bg-white card_shadow" >
          ...
          <div className="grid grid-cols-1 ">
            ...
            {todoList.map((item, index) => (
              <div className=" flex justify-between border rounded border-stone-300 px-3 py-3 my-1 bg-white" style={{ background: `${item.type == 'success' ? 'white' : '#FBF3E0'}` }} >
                <div>
                  <h3 className="todo-card-content-title">Internal*</h3>
                  <div className="flex justify-between">
                    <p className="todo-card-content-desc" >Regroup For SD 75 Presentation</p>
                  </div>
                </div>
                <div style={{ textAlign: '-webkit-right' }}>
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={(e) => closeTask(item)}>
                  ...
                  <p className="todo-card-content-desc" >Oct 16 {item.type == 'warning' ? 'EOD' : ''}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 ">
            ...
            {todoList.map((item, index) => (
              <div className=" flex justify-between border rounded border-stone-300 px-3 py-3 my-1 bg-white" style={{ background: `${item.type == 'success' ? '#DDF1EE' : '#DDF1EE'}` }} >
                <div>
                  <h3 className="todo-card-content-title">Internal*</h3>
                  <div className="flex justify-between">
                    <p className="todo-card-content-desc" >Regroup For SD 75 Presentation</p>
