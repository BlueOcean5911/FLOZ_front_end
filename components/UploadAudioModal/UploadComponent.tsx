...
const UploadComponent = ({ isUpload, uploadType, setUpload }) => {
        ...
        <div>
          <div >
            ...
            <button className="px-[16px] py-[6px] flex items-center rounded-md text-white text-[13px] bg-[#349989]" onClick={handleClick}>
              ...
              Upload Files</button>
            <input id="fileElem" accept={uploadType=='audio'?'audio/*':''} type="file" onChange={handleChange} multiple={uploadType == 'document' ? true : false} ref={hiddenFileInput} style={{ display: 'none' }} />
